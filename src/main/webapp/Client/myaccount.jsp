...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/dist/output.css">
			...
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">
				<div class="profile-tab-nav border-right">
					<div class="p-4">
						...
						<h4 class="text-center">${curCustomer.firstName}
							${curCustomer.lastName}</h4>
					</div>
					<div class="nav flex-column nav-pills" id="v-pills-tab"
						...
						<a class="nav-link" id="notification-tab" data-toggle="pill"
							...
							aria-selected="false"> <i class="fa fa-bell text-center mr-1"></i>
							Notification
						</a> <a class="nav-link" id="checkoutbill-tab" data-toggle="pill"
							href="#checkoutbill" role="tab" aria-controls="checkoutbill"
							aria-selected="false"> <i
							class="fa fa-money-bill text-center mr-1"></i> Check-Out Bill
						</a>
					</div>
				</div>
				<div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
					<form class="tab-pane fade show active"
						...
						method="post" id="account" role="tabpanel"
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>First Name</label> <input name="firstName" type="text"
										...
										value="${curCustomer.firstName}" maxlength="20"
										oninput="checkInputLength(this, 20)">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Last Name</label> <input name="lastName" type="text"
										...
										value="${curCustomer.lastName}" maxlength="20"
										oninput="checkInputLength(this, 20)">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Email</label> <input name="email" type="text"
										class="form-control" required="" value="${curCustomer.email}"
										maxlength="50" oninput="checkInputLength(this, 50)">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Phone number</label> <input name="phone" type="text"
										class="form-control" required=""
										value="${curCustomer.phonenumber}" maxlength="10"
										oninput="checkInputLength(this, 10)">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Address</label> <input name="address" type="text"
										class="form-control" required=""
										value="${curCustomer.address}" maxlength="100"
										oninput="checkInputLength(this, 100)">
					...
					<form class="tab-pane fade"
						...
						method="post" id="password" role="tabpanel"
						aria-labelledby="password-tab">
						<h3 class="mb-4">Password Settings</h3>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Old password</label> <input name="oldpass"
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>New password</label> <input name="newpass1"
										type="password" class="form-control" required="">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Confirm new password</label> <input name="newpass2"
										type="password" class="form-control" required="">
								</div>
							</div>
						</div>
						...
						<input id="statusmanage" value="${statusmanage}" hidden /> <input
							id="check_insert" value="${checkinsert}" hidden /> <input
							id="mess_insert" value="${messinsert}" hidden /> <input
							id="check_update" value="${checkupdate}" hidden /> <input
							id="mess_update" value="${messupdate}" hidden />
					</form>
						...
						<div class="form-group">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" value=""
									...
									for="notification1"> Get latest news about recent
									products from our shop. </label>
							</div>
						</div>
						<div>
					...
					<div class="tab-pane fade" id="checkoutbill" role="tabpanel"
						aria-labelledby="checkoutbill-tab">
						<div class='pb-4'>
							<h1 class='uppercase text-2xl font-semibold text-center p-4'>My
								bill list</h1>
							<table
		...
		if (status === 'true') {
			if (checkinsert === 'true')
				if (mess_in === 'true')
					...
					swal(
							"Thông Báo!",
							"Thêm Tài Khoản Không Thành Công UserName Đã Tồn Tại",
							"error");
			if (checkupdate === 'true')
				if (mess_up === 'true')
					...
					swal("Thông Báo!", "Cập Nhật Tài Khoản Không Thành Công",
							"error");
		}
		function checkInputLength(inputElement, maxLength) {
			var value = inputElement.value;
			var errorElement = document.getElementById(inputElement.name
					+ "Error");
			if (value.length > maxLength) {
				errorElement.textContent = "Vui lòng nhập không quá "
						+ maxLength + " ký tự.";
			} else {
